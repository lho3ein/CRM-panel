    ...
    <form id="signupForm" className="form-view space-y-4" noValidate>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            autoComplete="name"
          />
          <p className="field-error hidden" data-error-htmlfor="signupName"></p>
        </div>
        <div>
      ...
      <div>
        ...
        <input
          ...
          autoComplete="email"
        />
        <p className="field-error hidden" data-error-htmlfor="signupEmail"></p>
      </div>
      ...
      <label className="check-row">
        ...
        <span className="flex gap-1">
          با
          <a href="#" className="font-semibold text-harbor-700 hover:underline">
            شرایط استفاده
          </a>
          و
          <a href="#" className="font-semibold text-harbor-700 hover:underline">
